...
Scroll Drain (the "App") is an iOS application provided by NaRuLABO (the "Developer") that helps you see how much time you spend on social media.

**The App does not transmit any of your information off your device.** Everything the App works with is stored only on your device. The Developer never receives your information.

## 1. Information Stored

The App stores the following information on your device.

### (a) Social media usage time

The amount of time you spend in the apps you selected for tracking (both cumulative and for the current day), obtained through Apple's Screen Time APIs (Family Controls / Device Activity).

### (b) Your selection of tracked apps

Your selection is stored only as opaque identifiers (tokens) issued by Apple. Because of how this API is designed, **the Developer cannot determine which apps you selected.**
...
This information is used solely to display your own usage back to you, within the App and its Home Screen widget. It is not used for any other purpose.
...
The Developer does not share, sell, or rent your information to third parties. As described above, the Developer never receives your information in the first place.
